...
msg = str(datetime.datetime.now()) #NOT SECURE, NEED TO ADD MORE
...
content = {
    "type": "chngPermission",
    "state": True,
    "recDID": "0xaa8f61728cb614f37a2fdb8b420c3c33134c7f69", # change this
    "myDID": "0xf2beae25b23f0ccdd234410354cb42d08ed54981",
    "msg" : msg, # NOT SECURE, RUN A PROPER MSG IN FUTURE
    "sig": sig
}

request = requests.post("http://127.0.0.1:5001/api/changepermission", json=content)
print(request.text)